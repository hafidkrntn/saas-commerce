...
//
//	mockgen -source=pkg/cache/cache.go -destination=pkg/cache/mocks/cache.go -package=mocks Cache
//
...
func (m *MockCache) Fetch(ctx context.Context, key string, ttl time.Duration, dest any, loader func() (any, error)) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Fetch", ctx, key, ttl, dest, loader)
	ret0, _ := ret[0].(error)
	return ret0
}

// Fetch indicates an expected call of Fetch.
func (mr *MockCacheMockRecorder) Fetch(ctx, key, ttl, dest, loader any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Fetch", reflect.TypeOf((*MockCache)(nil).Fetch), ctx, key, ttl, dest, loader)
}
